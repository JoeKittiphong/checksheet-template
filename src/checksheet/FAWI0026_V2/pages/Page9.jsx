...
// Import image
import page9MachineFront from "@/assets/FAWI0026_V2/page9_machine_front.png";
...
const Page9 = () => {
    ...
    const checkAreas = [
        ...
        { id: 8, name: "950346a", top: "77%", left: "81%", label: "950346A (4 PCS)" },

        // Left side - 951782B
        { id: 9, name: "951782b", top: "47%", left: "25%", label: "951782B" },
        { id: 10, name: "950755b", top: "67%", left: "10%", label: "950755B" },

        // Middle area
        { id: 11, name: "915938", top: "80%", left: "25%", label: "915938" },
        { id: 12, name: "950733a", top: "85%", left: "50%", label: "950733A (2 PCS)" },

        // TS9768A
        { id: 13, name: "ts9768a", top: "66%", left: "85%", label: "TS9768A" },
        { id: 14, name: "ts9767a", top: "53%", left: "90%", label: "TS9767A" },
    ...
    return (
        <A4Paper content={content} currentPage={9}>
            <div className="p-1 flex flex-col h-full bg-white text-[10px]">
                {/* Header */}
                <SectionTitle>2. ด้านหน้าของเครื่องจักร และด้านใน Wiring Cover</SectionTitle>
