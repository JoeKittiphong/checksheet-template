...
// Import image
import page8CheckImg from "@/assets/FAWI0026_V2/page8_check.png";
...
const Page8 = () => {
    ...
    return (
        <A4Paper content={content} currentPage={8}>
            <h2 className='font-bold text-center underline mb-2'>5. Checl list sticker ALN400Q/ALN600Q (iG+E)  </h2>
            <h2 className='font-bold'>1. ด้านหน้าของเครื่องจักร</h2>
