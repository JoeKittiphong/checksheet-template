...
import image1 from "@/assets/FAWI0038_V2/p5-image1.png";
import image2 from "@/assets/FAWI0038_V2/p5-image2.png";
import image3 from "@/assets/FAWI0038_V2/p5-image3.png";
import image4 from "@/assets/FAWI0038_V2/p5-image4.png";
import image5 from "@/assets/FAWI0038_V2/p5-image5.png";
import image6 from "@/assets/FAWI0038_V2/p5-image6.PNG";
import image7 from "@/assets/FAWI0038_V2/p5-image7.png";
import image8 from "@/assets/FAWI0038_V2/p5-image8.png";
    ...
    const data = [
        {
            ...
            picture: image1,
            check1Items: ["ใส่ Tube TE-12 (สีขาว)\nยาว = 30 mm\nและเทปดำที่\nbobbin shaft แล้ว"]
        },
        {
            id: 20,
            partName: "ตรวจสอบการประกอบ\nBellows X",
            picture: image2,
            check1Items: ["Bellow ไม่ตกนอก\nราง และไม่มี Part,\nScrew ตกอยู่ภายใน"]
        },
        {
            id: 21,
            partName: "ตรวจสอบ Panel-R2(L)\nPanel-R2(L) ของ iG+E\nจะมีช่องเว้าตามภาพ",
            picture: image3,
            check1Items: ["Panel-R2(L) ของเครื่อง\niG+E จะต้องมีช่องตัดเว้า\nตามภาพ"]
        },
        {
            id: 22,
            partName: "Nozzle Base L\nFloat Nozzle S\n(Lower Guide)",
            picture: image4,
            check1Items: ["ไม่มีรอยขีดข่วน"]
        },
        {
            id: 23,
            partName: "Nozzle L (Lower Guide)\nD4 : USA (BRAZIL, MAXICO) &\nERP (NETHERLANDS, ITALY, TURKEY)\n\nD6 : Other Country.",
            picture: image5,
            check1Items: [
        ...
        },
        {
            ...
            picture: image7,
            check1Items: ["ตรวจสอบเครื่อง\nต้องประกอบ Discharge\nBKT L,R"]
        },
        {
            id: 25,
            partName: "Magnet Y",
