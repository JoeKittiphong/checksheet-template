...
import image1 from "@/assets/FAWI0006_V3/p4-image1.png";
import image2 from "@/assets/FAWI0006_V3/p4-image2.png";
import image3 from "@/assets/FAWI0006_V3/p4-image3.png";
import image4 from "@/assets/FAWI0006_V3/p4-image4.png";
import image5 from "@/assets/FAWI0006_V3/p4-image5.png";
import image6 from "@/assets/FAWI0006_V3/p4-image6.png";
import image7 from "@/assets/FAWI0006_V3/p4-image7.png";
import image8 from "@/assets/FAWI0006_V3/p4-image8.png";
import image9 from "@/assets/FAWI0006_V3/p4-image9.png";
import image10 from "@/assets/FAWI0006_V3/p4-image10.png";
...
const Page4 = () => {
    ...
    const data = [
        ...
        },
        {
            ...
            check1Items: ["ไม่มีรอยขีดข่วน สกรูที่ล็อคแน่น"]
        },
        {
            id: 12,
            partName: "Workstand\nCap Screw",
            picture: image3,
            check1Items: [
                "1. ไม่มีรอยขีดข่วน, รอยด่าง, สนิม",
                "2. อุด Cap ครบทุกจุด",
                "3. Cap ทุกตัวต้องไม่สูงเกินผิวของ Workstand"
            ]
        },
        {
            id: 13,
            partName: "**เฉพาะ ALN600G**\nเบิกสกรูที่ถอดจาก Bed Cover-R1\n(CR M5x10 + Poly = 1 Pc.)\nแพ็คบน Work Stand",
            picture: image4,
            check1Items: ["แพ็คใส่ถุงพลาสติก วางบน Work Stand"]
        },
        {
            id: 14,
            ...
            check1Items: [
                "ขันขึ้นจนสุดและล็อค",
                "Mark สีขาว, เขียว ทาจารบีที่ Leveling Adjuster ทั้ง 5 ตำแหน่ง"
            ]
        },
        {
            id: 15,
            ...
            picture: image6,
            check1Items: ["ตรวจสอบการประกอบสกรูที่ชุดแปรง"]
        },
        {
            id: 16,
            partName: "Snail Guide (Wire Feed L)",
            picture: image7,
            check1Items: ["Snail Guide จะต้องไม่หลุดหลวม"]
        },
        {
            id: 17,
            partName: "Pulley Unit (Wire Feed L)",
            picture: image8,
            check1Items: ["เก็บยึดชุด Pulley Unit แล้ว"]
        },
        {
            id: 18,
            partName: "**เครื่องที่ไม่มี Wire Feeder 20 kg**\nBobbin Shaft & Bobbin Lock\n(Wire Feed L)",
            picture: image9,
            check1Items: ["ล็อค bobbin lock เพิ่มอีก 30 องศา หลังจากหมุนแตะแล้ว"]
        },
        {
            id: "18b",
            partName: "**เครื่องที่มี Wire Feeder 20 kg**\nBobbin Shaft & Bobbin Lock\n(Wire Feed L)",
            picture: image10,
            check1Items: ["ล็อค bobbin lock เพิ่มอีก 60 องศา หลังจากหมุนแตะแล้ว"]
        },
    ];
