        ...
        <A4Paper content={content} currentPage={15}>
            <div>
                ...
                <div className="flex">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex mb-1">
                            ...
                            <FormChecknumber
                                name="page15.dialGaugeNo2"
                                label="Dial gauge No."
                            />
                        </div>
                        <div className="flex flex-col gap-2 ml-10 mb-1">
                            <Controller
                                name="page15.flSelector"
                                control={control}
                                defaultValue=""
                                render={({ field }) => (
                                    <EntoSideSelector
                ...
                <div className="flex justify-between ml-10 mr-20">
                    ...
                    <FormCheckedBox name="page15.checkedInfo23" />
                </div>
            </div>
        </A4Paper>
    );
