...
// Images
import image1_diagram from "@/assets/FAMB0014_V2/FAMB0015-1.PNG"; // Tentative
import image1_diagram2 from "@/assets/FAMB0014_V2/FAMB0015-2.PNG"; // Tentative

function Page1() {
    const { register, watch, setValue, control } = useFormContext(); // Restore control
    const [model, setModel] = useState("AL40G");
                ...
                <div>
                    ...
                    <div className="flex justify-center relative">
                        ...
                        <div className="absolute right-10 top-0 flex flex-col gap-2">
                            <div className="flex items-center gap-2 border p-1 rounded cursor-pointer hover:bg-gray-100" onClick={() => setModel("AL40G")}>
                                <div className={`w-4 h-4 border rounded-full ${model === "AL40G" ? "bg-black" : "bg-white"}`}></div>
                                <span>AL40G (260)</span>
                            </div>
                            <div className="flex items-center gap-2 border p-1 rounded cursor-pointer hover:bg-gray-100" onClick={() => setModel("AL60G")}>
                                <div className={`w-4 h-4 border rounded-full ${model === "AL60G" ? "bg-black" : "bg-white"}`}></div>
                                <span>AL60G (360)</span>
                            </div>
                        </div>
                    </div>
