...
// Images
import image23_1 from "@/assets/FAMB0006_V2/FAMB0005-18-1.PNG";
import image23_2 from "@/assets/FAMB0006_V2/FAMB0005-18-2.PNG";
import image23_3 from "@/assets/FAMB0006_V2/FAMB0005-18-3.PNG";
        ...
        <A4Paper content={content} currentPage={12}>
            <div>
                ...
                <div className="flex p-2">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex mb-5 ml-10">
                            <img src={image23_1} alt="page12" className="w-16" />
                            <FormChecknumber
                                name="page12.entoNo1"
                                label="ENTO No."
                            />
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex mb-5">
                            <img src={image23_2} alt="page12" className="w-16" />
                            <FormChecknumber
                ...
                <div className="flex justify-between ml-10 mr-20">
                    <img src={image23_3} alt="page12" className="w-80 h-full" />
                    <FormCheckedBox name="page12.checkedInfo23" />
                </div>
            </div>
        </A4Paper>
    );
