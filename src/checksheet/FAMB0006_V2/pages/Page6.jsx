...
// Images
import image17 from "@/assets/FAMB0006_V2/FAMB0005-10.PNG";
        ...
        <A4Paper content={content} currentPage={6}>
            <div>
                ...
                <div className="ml-10">
                    ...
                    <div className="flex justify-between ml-30 mr-10">
                        <div className="mt-5 space-y-2">
                            ...
                            />
                            <FormChecknumber
                                name="page6.ceramicBaseNo"
                                label="Ceramic base No."
                            />
                        </div>
                        <FormCheckedBox name="page6.checkedInfo16" />
                    </div>
                </div>
                ...
                <div>
                    <div>
                        <div className="flex">
                            <img src={image17} alt="page6" className="w-80 mb-10 ml-5 mr-10" />
                            <FormEDMLevelCeramic
                                name="page6.levelCeramicData"
                                standardX={20}
                                standardY={20}
                                defaultValue={{
                                    x: {
                        ...
                        <div className="mt-5 flex justify-between ml-30 mr-10">
                            <FormChecknumber
                                name="page6.levelingGuageNo"
                                label="Leveling gauge No."
                            />
                            <FormCheckedBox name="page6.checkedInfo17" />
                        </div>
                    </div>
                </div>
            </div>
