...
function Page5() {
    ...
    // AL400G Table
    const dataAL400G = [
        { sig: "(Std:80+2)", v_l: "V0", volt_l: "DC 70 V", v_r: "V5", volt_r: "DC 170 V", type: "input", measured_l: "p5_al400_v0_meas", setting_l: "p5_al400_v0_set", measured_r: "p5_al400_v5_meas", setting_r: "p5_al400_v5_set" },
        { sig: "---", v_l: "V1", volt_l: "80 V", v_r: "V6", volt_r: "195 V", type: "input", measured_l: "p5_al400_v1_meas", setting_l: "p5_al400_v1_set", measured_r: "p5_al400_v6_meas", setting_r: "p5_al400_v6_set" },
        { sig: "---", v_l: "V2", volt_l: "95 V", v_r: "V7", volt_r: "230 V", type: "input", measured_l: "p5_al400_v2_meas", setting_l: "p5_al400_v2_set", measured_r: "p5_al400_v7_meas", setting_r: "p5_al400_v7_set" },
        { sig: "---", v_l: "V3", volt_l: "115 V", v_r: "V8", volt_r: "245 V", type: "input", measured_l: "p5_al400_v3_meas", setting_l: "p5_al400_v3_set", measured_r: "p5_al400_v8_meas", setting_r: "p5_al400_v8_set" },
        { sig: "---", v_l: "V4", volt_l: "140 V", v_r: "V9", volt_r: "290 V", type: "input", measured_l: "p5_al400_v4_meas", setting_l: "p5_al400_v4_set", measured_r: "p5_al400_v9_meas", setting_r: "p5_al400_v9_set" },
    ];
    ...
    const dataAL600G = [
        { sig: "(Std:80+2)", v_l: "V0", volt_l: "DC 70 V", v_r: "V5", volt_r: "DC 180 V", type: "input", measured_l: "p5_al600_v0_meas", setting_l: "p5_al600_v0_set", measured_r: "p5_al600_v5_meas", setting_r: "p5_al600_v5_set" },
        { sig: "---", v_l: "V1", volt_l: "80 V", v_r: "V6", volt_r: "210 V", type: "input", measured_l: "p5_al600_v1_meas", setting_l: "p5_al600_v1_set", measured_r: "p5_al600_v6_meas", setting_r: "p5_al600_v6_set" },
        { sig: "---", v_l: "V2", volt_l: "100 V", v_r: "V7", volt_r: "250 V", type: "input", measured_l: "p5_al600_v2_meas", setting_l: "p5_al600_v2_set", measured_r: "p5_al600_v7_meas", setting_r: "p5_al600_v7_set" },
        { sig: "---", v_l: "V3", volt_l: "120 V", v_r: "V8", volt_r: "265 V", type: "input", measured_l: "p5_al600_v3_meas", setting_l: "p5_al600_v3_set", measured_r: "p5_al600_v8_meas", setting_r: "p5_al600_v8_set" },
        { sig: "---", v_l: "V4", volt_l: "150 V", v_r: "V9", volt_r: "310 V", type: "input", measured_l: "p5_al600_v4_meas", setting_l: "p5_al600_v4_set", measured_r: "p5_al600_v9_meas", setting_r: "p5_al600_v9_set" },
    ];
    ...
    const dataMainVoltage = [
        { pc_l: "000000", volt_l: "DC 80 V", def_l: "80", pc_r: "050000", volt_r: "DC 130 V", def_r: "130", type: "input", meas_l: "p5_main_00_meas", set_l: "p5_main_00_set", meas_r: "p5_main_05_meas", set_r: "p5_main_05_set" },
        { pc_l: "010000", volt_l: "90 V", def_l: "90", pc_r: "060000", volt_r: "140 V", def_r: "140", type: "input", meas_l: "p5_main_01_meas", set_l: "p5_main_01_set", meas_r: "p5_main_06_meas", set_r: "p5_main_06_set" },
        { pc_l: "020000", volt_l: "100 V", def_l: "100", pc_r: "070000", volt_r: "150 V", def_r: "150", type: "input", meas_l: "p5_main_02_meas", set_l: "p5_main_02_set", meas_r: "p5_main_07_meas", set_r: "p5_main_07_set" },
        { pc_l: "030000", volt_l: "110 V", def_l: "110", pc_r: "080000", volt_r: "160 V", def_r: "160", type: "input", meas_l: "p5_main_03_meas", set_l: "p5_main_03_set", meas_r: "p5_main_08_meas", set_r: "p5_main_08_set" },
        { pc_l: "040000", volt_l: "120 V", def_l: "120", pc_r: "090000", volt_r: "(160 V)", def_r: "(160)", type: "input", meas_l: "p5_main_04_meas", set_l: "p5_main_04_set", meas_r: "p5_main_09_meas", set_r: "p5_main_09_set" },
    ];
        ...
        <A4Paper content={content} currentPage={5}>
            <div className="flex flex-col text-[10px] h-full relative">
                ...
                <div className="mt-1">
                    ...
                    {/* AL400G Section */}
                    <div className='mt-5'>
                        <FormItemCheck name="p5_al400_check" label="AL400G (Same Value between STD and HSP)" showCheckbox={true} className="font-bold mb-1" />
                        <div className="border border-black text-center font-bold bg-gray-100 text-[10px] py-0.5">Measuring Terminal (H20 - H4)</div>
                        <FormQuickTable columns={columnsVoltageCheck} data={dataAL400G} headerClassName="bg-gray-100 font-bold" />
                    </div>

                    {/* AL600G Section */}
                    {/* <div className="mt-4">
                        <FormItemCheck name="p5_al600_check" label="AL600G (Same Value between STD and HSP)" showCheckbox={true} className="font-bold mb-1" />
                        <div className="border border-black text-center font-bold bg-gray-100 text-[10px] py-0.5">Measuring Terminal (H20 - H4)</div>
                        <FormQuickTable columns={columnsVoltageCheck} data={dataAL600G} headerClassName="bg-gray-100 font-bold" />
                    </div> */}
