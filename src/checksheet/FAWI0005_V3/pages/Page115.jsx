...
function Page115() {
    ...
    const checkItems = [
        { label: "Disch-Page5-[[163]PULSE CONVERT ON 02]=", key: "p115_check1" },
        { label: "Disch-Page5-[[193] MODIFY P.CONVERT TM(W) PC0_8]=", key: "p115_check2" },
        { label: "Disch-Page5-[[194] MODIFY P.CONVERT TM(W) PC9]=", key: "p115_check3" },
        { label: "Disch-Page3 -[MODIFY WORKING CORE SV18]=           => (ห้ามแก้ไขก่อนแจ้ง ENG)", key: "p115_check4" },
        { label: "Disch-Page3 -[MODIFY WORKING CORE SV19]=           => (ห้ามแก้ไขก่อนแจ้ง ENG)", key: "p115_check5" },
        { label: "Disch-Page4-[[148]  DPW PC02-22 V7]=           (For 5th Cutting)      => (ห้ามแก้ไขก่อนแจ้ง ENG)", key: "p115_check6" },
        { label: "Disch-Page4-[[149]  DPW PC02-22 V8]=           (For 5th Cutting)      => (ห้ามแก้ไขก่อนแจ้ง ENG)", key: "p115_check7" },
        { label: "Disch-Page4-[[135]  DPW PC01-21 V4]=           (For 7th Cutting)", key: "p115_check8" },
        { label: "Disch-Page4-[[136]  DPW PC01-21 V5]=           (For 7th Cutting)", key: "p115_check9" },
        { label: "Disch-Page4-[[137]  DPW PC01-21 V6]=           (For 6th Cutting)", key: "p115_check10" },
        { label: "Disch-Page4-[[138]  DPW PC01-21 V7]=           (For 6th Cutting)", key: "p115_check11" },
    ];

    // Config for EDWFinalRecordCutting
    const cuttingRows = [
        { id: "C0001", stdKey: "c0001", voltage_key: "p115_c1_v", current_key: "p115_c1_a", speed_key: "p115_c1_spd", time_label: "H071=", placeholderV: "H121", placeholderA: "H141", placeholderSpeed: "H101" },
        { id: "C0002", stdKey: "c0002", voltage_key: "p115_c2_v", current_key: "p115_c2_a", speed_key: "p115_c2_spd", time_label: "H072=", placeholderV: "H124", placeholderA: "H144", placeholderSpeed: "H104" },
        { id: "C0003", stdKey: "c0003", voltage_key: "p115_c3_v", current_key: "p115_c3_a", speed_key: "p115_c3_spd", time_label: "H073=", placeholderV: "H125", placeholderA: "H145", placeholderSpeed: "H105" },
        { id: "C0004", stdKey: "c0004", voltage_key: "p115_c4_v", current_key: "p115_c4_a", speed_key: "p115_c4_spd", time_label: "H074=", placeholderV: "H128", placeholderA: "H148", placeholderSpeed: "H108" },
        { id: "C0905", stdKey: "c0905", voltage_key: "p115_c5_v", current_key: "p115_c5_a", speed_key: "p115_c5_spd", time_label: "H075=", disabled: { current: true }, placeholderV: "H129", placeholderSpeed: "H109" },
        { id: "C0906", stdKey: "c0906", voltage_key: "p115_c6_v", current_key: "p115_c6_a", speed_key: "p115_c6_spd", time_label: "H076=", disabled: { current: true }, placeholderV: "H132", placeholderSpeed: "H112" },
        { id: "C0907", stdKey: "c0907", voltage_key: "p115_c7_v", current_key: "p115_c7_a", speed_key: "p115_c7_spd", time_label: "H077=", disabled: { current: true }, placeholderV: "H133", placeholderSpeed: "H113" },
        { id: "Wire broken", isFooter: true, key: "p115_wire_broken", time_key: "p115_h081_time", speed_key: "p115_time_s", timeLabel: "H081=" }
    ];

    const page115Standards = {
    ...
    return (
        <A4Paper content={content} currentPage={115}>
            <div className="relative text-[10px] font-sans">
                <SectionTitle>24.5 For 0.20mm Wire Cutting Data CUT-2 (ACR2-20mm-7th)</SectionTitle>
                ...
                <div>
                    <EDWFinalRecordCutting
                        ...
                        standards={page115Standards}
                        lastTimeRow={{ label: "H081=", std: "H081= 45:00~51:00", key: "p115_h081_time" }} // Added support for H081 if component supports it, or custom
                    />
                    ...
                    <div className="flex gap-4 items-center mt-2 text-xs">
                        <FormItemCheck name="p115_wb_upper" label="Upper Guide" />
                        <FormItemCheck name="p115_wb_lower" label="Lower Guide" />
                        <FormItemCheck name="p115_wb_work" label="Work Piece" />
                    </div>
                </div>
