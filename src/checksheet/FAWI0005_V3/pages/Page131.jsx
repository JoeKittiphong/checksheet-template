...
function Page131() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p131_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 131 (4th cut, 80mm - GALPM)
    const cuttingStandards = {
        c0001: { v: "24~29", a: "8~12", speed: "0.85~1.10", time: "H071= 33:00~46:00" },
        c0002: { v: "42~49", a: "1.0~2.4", speed: "1.5~3.0", time: "H072= 14:00~19:00" },
        c0003: { v: "19~23", a: "-", speed: "3.0~5.0", time: "H073= 06:00~11:00" },
        c0904: { v: "3~7", a: "-", speed: "1.9~5.0", time: "H073= 10:00~20:00" },
        totalTime: "H081= 1:10:00~1:23:00"
    };

    // Custom data rows (C0001-C0003 + C0904)
    const cuttingDataRows = [
        ...
        { id: "C0904", placeholderV: "H127", placeholderA: "", placeholderSpeed: "H107", timeLabel: "H074=", stdKey: "c0904", disabled: { current: true } },
        { id: "Wire broken", isFooter: true, timeLabel: "H081=" }
    ];
    ...
    const cuttingStdRows = [
        ...
        { v: cuttingStandards.c0904.v, a: cuttingStandards.c0904.a, speed: cuttingStandards.c0904.speed, time: cuttingStandards.c0904.time },
        { v: "", a: "", speed: "", time: cuttingStandards.totalTime, className: "text-[9px] bg-green-500 font-bold" }
    ];


    return (
        <A4Paper content={content} currentPage={131}>
            <SectionTitle>26.2 For 0.20mm Wire Cutting Data CUT-2</SectionTitle>

            <div className="text-xs font-bold px-4">Frequency servo GALPM Cutting check</div>
            <div className="text-xs px-4 ml-4">[Thickness=80mm-4th]</div>

            <div className="flex justify-between items-start px-4 mt-1">
                <div className="text-xs space-y-1 w-1/2">
                    <p>Disch2-Page3 -[GALPM FRQ BACK REV (V0~V9)]=</p>
                    <p className="text-[10px] ml-4">Put the same value in all 10 items from V0 to 9</p>
                </div>

                <div className='flex flex-col items-end gap-2 w-100'>
                    <FinalEDWwireCheck prefix="p131_" />
            ...
            <div className="flex gap-4 px-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs mt-1">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p131_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p131_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p131_wb_work" label="Work Piece" showCheckbox />
            ...
            <div className="flex gap-4 px-4 mt-2">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="w-48 ml-auto mb-4">
                        <FormItemCheck
                            name="p131_wire_lot_no"
                            label="Wire Lot No."
                            showCheckbox={false}
                            input={{ name: "p131_wire_lot_no", width: "100px" }}
