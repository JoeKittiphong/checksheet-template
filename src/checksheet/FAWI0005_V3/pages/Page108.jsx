...
import topDiagram from "@/assets/FAWI0005_V3/page108_diagram_top.png";
import sideDiagram from "@/assets/FAWI0005_V3/page108_diagram_side.png";
...
function Page108() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p108_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 108
    ...
    return (
        <A4Paper content={content} currentPage={108}>
            <SectionTitle>23.4 Cutting Data CUT-2</SectionTitle>
            ...
            <div className="flex gap-4 px-4 mt-4">
                <div className="w-full">
                    <div className="flex items-end justify-between">
                        ...
                        <div className="text-xs space-y-1 text-right flex flex-col items-end">
                            <div className="flex items-center gap-2">
                                ...
                                <FormItemCheck
                                    name="p108_flow_meter"
                                    input={{
                                        name: "p108_flow_meter_val",
                                        width: "60px",
                    ...
                    <div className="flex justify-end items-center gap-2 text-xs mt-2">
                        <FormItemCheck
                            name="p108_wire_lot_check"
                            label="Wire Lot No."
                            input={{
                                name: "p108_wire_lot_no",
                                width: "200px",
                                className: "text-center"
                            }}
                            showCheckbox={false}
            ...
            <div className="w-1/2 pl-4 flex flex-col items-center">
                <FinalEDWwireCheck prefix="p108_" />
            </div>
