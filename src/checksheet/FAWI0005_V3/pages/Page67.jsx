...
function Page67() {
    ...
    const calcVal1 = useWatch({ control, name: "p67_calc_val1" });
    const calcVal2 = useWatch({ control, name: "p67_calc_val2" });
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p67_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 67
    ...
    return (
        <A4Paper content={content} currentPage={67}>
            <SectionTitle>19.4 For 0.20mm Wire Machine data-1 (IG-S4-80mm-3rd)</SectionTitle>
            ...
            <div className="flex gap-4 px-4 mt-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p67_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p67_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p67_wb_work" label="Work Piece" showCheckbox />
            ...
            <div className="px-4 text-xs space-y-2">
                <div className="flex items-center gap-1">
                    ...
                    <input
                        {...register("p67_calc_val1", { required: true })}
                        className={`border-b border-black w-12 text-center outline-none ${errors.p67_calc_val1 ? 'bg-red-500' : ''}`}
                        placeholder="_____"
                        type="number" step="any"
                    />
                    <span> - </span>
                    <input
                        {...register("p67_calc_val2", { required: true })}
                        className={`border-b border-black w-12 text-center outline-none ${errors.p67_calc_val2 ? 'bg-red-500' : ''}`}
                        placeholder="_____"
                        type="number" step="any"
                    />
                    <span> = </span>
