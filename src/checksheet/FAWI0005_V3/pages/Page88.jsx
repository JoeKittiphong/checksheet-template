...
function Page88() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p88_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 88
    ...
    return (
        <A4Paper content={content} currentPage={88}>
            <SectionTitle>21.4 For 0.20mm Wire Cutting Data CUT-1 (STD2-80mm-4th)</SectionTitle>
            ...
            <div className="flex gap-4 px-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs mt-1">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p88_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p88_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p88_wb_work" label="Work Piece" showCheckbox />
