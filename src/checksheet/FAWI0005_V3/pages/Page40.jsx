...
function Page40() {
    ...
    return (
        <A4Paper content={content} currentPage={40}>
            <SectionTitle>17.4 For 0.20mm Wire Machine Data-4 (STD-80mm-3rd)</SectionTitle>
            ...
            <div className="flex gap-4 px-4 mt-4">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="text-xs space-y-2">
                        ...
                        <FormItemCheck
                            name="p40_wire_lot1_check"
                            label="Wire Lot No."
                            input={{ name: "p40_wire_lot1", width: "120px" }}
                            showCheckbox={false}
                        />
                        <FormItemCheck
                            name="p40_wire_lot2_check"
                            label="Wire Lot No."
                            input={{ name: "p40_wire_lot2", width: "120px" }}
                            showCheckbox={false}
                        />
                    </div>
