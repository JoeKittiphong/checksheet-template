...
function Page21() {
    const speedData = [
        { label: "Cutting Speed", std: "2.90~3.00", name: "p21_speed", name_min: 2.90, name_max: 3.00 },
        { label: "Voltage (LCD)", std: "23~31", name: "p21_voltage", name_min: 23, name_max: 31 },
        { label: "Current (LCD)", std: "13~16", name: "p21_current", name_min: 13, name_max: 16 },
        {
            label: "Pulse-conversion compensation TM (W) PC0_9",
            name: "p21_pulse_comp_manual",
            label_colSpan: 2
        },
    ];
            ...
            <div className="flex flex-col text-[10px] h-full relative p-4">
                ...
                <div className="mb-6 space-y-1 text-[11px] font-bold">
                    <div className="flex items-start">
                        ...
                        <span>ถ้าค่า Speed อยู่ในช่วง Standard ให้ขามไปบันทึกค่าที่ขอ 12b.3 ได้เลย</span>
                    </div>
                    <div className="flex items-start pl-10">
                        <span className="mr-2 shrink-0">:</span>
                        <span>ถ้าค่า Speed ไม่ได้ตาม Standard ให้นำค่า Pulse offset มาใส่ที่ MODIFY P. CONVERT TM(W) PC 9</span>
                    </div>
                </div>

                {/* Section 12b.3 */}
                <div className="mt-4">
                    <SectionTitle className="mb-2 w-max">12b.3 Cutting อีกครั้ง, ถ้าค่า Measured ไม่อยู่ในช่วง Standard ให้กลับไปทำข้อ 12b.2 ใหม่อีกครั้ง</SectionTitle>
