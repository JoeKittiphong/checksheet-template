...
function Page98() {
    ...
    // Cutting Standards for Page 98 (Green Table)
    // C001, C002, C003, C904
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p98_io_retry_act", type: "input" }
    ];

    return (
        <A4Paper content={content} currentPage={98}>
            <SectionTitle>22.4 For 0.20mm Wire Machine Data CUT-1 (STD2-40mm-4th)</SectionTitle>
            ...
            <div className="relative flex justify-between items-start px-4 text-[10px] font-sans mt-2">
                <div className="space-y-2 w-2/3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input className="border-b border-black w-24 outline-none text-center" {...register("p98_sv29")} />
                    </div>
            ...
            <div className="px-4 mb-4 mt-8">
                ...
                <EDWFinalRecordCutting prefix="p98_" standards={cuttingStandards} />
                <div className="flex items-center gap-4 text-[10px]">
                    <div className="flex items-center gap-2 ml-auto">
                        <span>Wire Broken Point=</span>
                        <FormItemCheck checkboxSize="w-4 h-4" name="p98_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p98_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p98_wb_work" label="Work Piece" showCheckbox />
                    </div>
                    ...
                    <div className="text-[9px] font-bold mt-2">
                        <div className="flex justify-between items-center ">
                            <div className="flex items-center gap-1">
                                ...
                                <input className="border-b border-black w-20 text-center outline-none" {...register("p98_max_no")} />
                            </div>
                            <div className="flex items-center gap-1">
                                <span>Minimum No.</span>
                                <input className="border-b border-black w-20 text-center outline-none" {...register("p98_min_no")} />
                            </div>
                        </div>

                        <div className="flex items-center gap-1">
                            <span>Culculate Range error fallowing formula --&gt; [ Max ] - [ Min ] = </span>
                            <input className="border-b border-black w-20 text-center outline-none" {...register("p98_range_error")} />
                        </div>

                        <div className="flex items-center gap-1">
                            <span>Culculate Size error fallowing formula --&gt; [ (a-e) Mid ] - [ (c-g) Mid ] = </span>
                            <input className="border-b border-black w-20 text-center outline-none" {...register("p98_size_error")} />
                        </div>
                    </div>
                </div>
