...
function Page133() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p133_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 133 (4th cut, 80mm - GALPM)
    ...
    return (
        <A4Paper content={content} currentPage={133}>
            <SectionTitle>26.2 For 0.20mm Wire Cutting Data CUT-4</SectionTitle>
            ...
            <div className="flex justify-between items-start px-4 mt-1">
                ...
                <div className='flex flex-col items-end gap-2 w-100'>
                    <FinalEDWwireCheck prefix="p133_" />
            ...
            <div className="flex gap-4 px-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs mt-1">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p133_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p133_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p133_wb_work" label="Work Piece" showCheckbox />
            ...
            <div className="flex gap-4 px-4 mt-2">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="w-48 ml-auto mb-4">
                        <FormItemCheck
                            name="p133_wire_lot_no"
                            label="Wire Lot No."
                            showCheckbox={false}
                            input={{ name: "p133_wire_lot_no", width: "100px" }}
