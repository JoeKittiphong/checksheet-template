...
function Page56() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p56_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 56
    ...
    return (
        <A4Paper content={content} currentPage={56}>
            <SectionTitle>18.4 For 0.20mm Wire Cutting Data CUT-7 (STD-80mm-4th)</SectionTitle>
            ...
            <div className="flex gap-4 px-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        ...
                        <FormItemCheck checkboxSize="w-3 h-3" name="p56_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-3 h-3" name="p56_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-3 h-3" name="p56_wb_work" label="Work Piece" showCheckbox />
                    </div>
                </div>
            </div>
            ...
            <div className="flex gap-4 px-4 mt-4">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="text-xs space-y-2">
                        ...
                        <FormItemCheck
                            name="p56_wire_lot_check"
                            label="Wire Lot No."
                            input={{ name: "p56_wire_lot", width: "120px" }}
                            showCheckbox={false}
                        />
                    </div>
