...
function Page39() {
    ...
    const dataRecord = [
        {
            ...
            voltage: "p39_c0001_volt", voltage_min: 26, voltage_max: 34,
            current: "p39_c0001_curr", current_min: 10, current_max: 13,
            speed: "p39_c0001_speed", speed_min: 0.95, speed_max: 1.25,
            time: "p39_c0001_time_label", label: "H071="
        },
        {
            point: "C0002", type: "input",
            voltage: "p39_c0002_volt", voltage_min: 47, voltage_max: 55,
            current: "p39_c0002_curr", current_min: 1.0, current_max: 2.4,
            speed: "p39_c0002_speed", speed_min: 2.0, speed_max: 3.0,
            time: "p39_c0002_time_label", label: "H072="
        },
        {
            point: "C0903", type: "input",
            voltage: "p39_c0903_volt", voltage_min: 30, voltage_max: 38,
            current: "p39_c0903_curr", current_disabled: true,
            speed: "p39_c0903_speed", speed_min: 4.5, speed_max: 5.5,
            time: "p39_c0903_time_label", label: "H073="
        }
    ];
    ...
    const dataRa = [
        { row_label: "Up", x_minus: "p39_ra_up_xm", type: "input", y_minus: "No need", x_plus: "No need" },
        { row_label: "Mid", x_minus: "p39_ra_mid_xm", type: "input", y_minus: "No need", x_plus: "No need" },
        { row_label: "Low", x_minus: "p39_ra_low_xm", type: "input", y_minus: "No need", x_plus: "" },
        {
            row_label: "STD(μm)",
            x_minus: "0.530~0.630",
            y_minus: "No need",
    ...
    const dataRz = [
        { row_label: "Up", x_minus: "p39_rz_up_xm", type: "input", y_minus: "No need", x_plus: "No need" },
        { row_label: "Mid", x_minus: "p39_rz_mid_xm", type: "input", y_minus: "No need", x_plus: "No need" },
        { row_label: "Low", x_minus: "p39_rz_low_xm", type: "input", y_minus: "No need", x_plus: "" },
        {
            row_label: "STD(μm)",
            x_minus: "3.70~4.80",
            y_minus: "No need",
    ...
    const dataSize = [
        { row_label: "Up", x_minus: "p39_size_up_xm", type: "input", y_val: "p39_size_up_y" },
        { row_label: "Mid", x_minus: "p39_size_mid_xm", type: "input", y_val: "p39_size_mid_y" },
        { row_label: "Low", x_minus: "p39_size_low_xm", type: "input", y_val: "p39_size_low_y" },
        {
            row_label: "STD(mm)",
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p39_io_retry_act", type: "input" }
    ];

    return (
        <A4Paper content={content} currentPage={39}>
            <SectionTitle>17.4 For 0.20mm Wire Machine Data-3 (STD-80mm-3rd)</SectionTitle>
            <div className="flex justify-between items-start px-4 mt-2">
                ...
                <div className="w-1.5/3 border border-black p-2 text-xs">
                    <div className="flex items-center gap-1">
                        ...
                        <FormItemCheck name="p39_judge_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_judge_ng" label="NG" showCheckbox />
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-bold w-10">Line</span>
                        <FormItemCheck name="p39_line_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_line_ng" label="NG / XY-Size" showCheckbox />
                        <FormItemCheck name="p39_line_size_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_line_size_ng" label="NG" showCheckbox />
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-bold w-10">Ra/Rz</span>
                        <FormItemCheck name="p39_rarz_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_rarz_ng" label="NG / Size" showCheckbox />
                        <FormItemCheck name="p39_rarz_size_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_rarz_size_ng" label="NG" showCheckbox />
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-bold w-10">Barrel</span>
                        <FormItemCheck name="p39_barrel_ok" label="OK" showCheckbox />
                        <FormItemCheck name="p39_barrel_ng" label="NG" showCheckbox />
                    </div>
                    <div className="flex justify-between mt-2 gap-2">
                        <FormItemCheck
                            name="p39_date_check"
                            label="Date:"
                            input={{ name: "p39_date", width: "80px" }}
                            showCheckbox={false}
                        />
                        <FormItemCheck
                            name="p39_name_check"
                            label="Name:"
                            input={{ name: "p39_name", width: "80px" }}
                            showCheckbox={false}
                        />
                    </div>
                </div>
                ...
                <div className="w-1/2 mt-11">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-xs">
                        <FormItemCheck
                            name="p39_wb_check"
                            label="Wire Broken ="
                            input={{ name: "p39_wb_val", width: "30px" }}
                            showCheckbox={false}
                        />
                        <FormItemCheck
                            name="p39_time_check"
                            label="Time(s)"
                            input={{ name: "p39_time_val", width: "30px" }}
                            showCheckbox={false}
                        />
                        <FormItemCheck
                            name="p39_h081_check"
                            label="H081="
                            input={{ name: "p39_h081_val", width: "30px" }}
                            showCheckbox={false}
                        />
                    </div>
                    <div className="flex items-center gap-2 mt-2 text-xs">
                        <span>Wire Broken Point=</span>
                        <FormItemCheck checkboxSize="w-3 h-3" name="p39_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-3 h-3" name="p39_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-3 h-3" name="p39_wb_work" label="Work Piece" showCheckbox />
                    </div>
                </div>
            ...
            <div className="flex gap-4 px-4">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="text-xs space-y-2">
                        ...
                        <FormItemCheck
                            name="p39_wire_lot1_check"
                            label="Wire Lot No."
                            input={{ name: "p39_wire_lot1", width: "120px" }}
                            showCheckbox={false}
                        />
                        <FormItemCheck
                            name="p39_wire_lot2_check"
                            label="Wire Lot No."
                            input={{ name: "p39_wire_lot2", width: "120px" }}
                            showCheckbox={false}
                        />
                    </div>
