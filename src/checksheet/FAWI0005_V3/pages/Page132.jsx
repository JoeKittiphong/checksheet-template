...
function Page132() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p132_io_retry_act", type: "input" }
    ];

    // Cutting Standards for Page 132 (4th cut, 80mm - GALPM)
    ...
    return (
        <A4Paper content={content} currentPage={132}>
            <SectionTitle>26.2 For 0.20mm Wire Cutting Data CUT-3</SectionTitle>
            ...
            <div className="flex justify-between items-start px-4 mt-1">
                ...
                <div className='flex flex-col items-end gap-2 w-100'>
                    <FinalEDWwireCheck prefix="p132_" />
            ...
            <div className="flex gap-4 px-4">
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-2 text-xs mt-1">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p132_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p132_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p132_wb_work" label="Work Piece" showCheckbox />
            ...
            <div className="flex gap-4 px-4 mt-2">
                ...
                <div className="w-1/2 pl-4">
                    ...
                    <div className="w-48 ml-auto mb-4">
                        <FormItemCheck
                            name="p132_wire_lot_no"
                            label="Wire Lot No."
                            showCheckbox={false}
                            input={{ name: "p132_wire_lot_no", width: "100px" }}
