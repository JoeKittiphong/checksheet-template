...
function Page81() {
    ...
    const dataIORetry = [
        { code: "#80061", desc: "IO Retry", std: "0", act: "p81_io_retry_act", type: "input" }
    ];

    return (
        <A4Paper content={content} currentPage={81}>
            <SectionTitle>20.4 For 0.20mm Wire Machine Data CUT-4 (IG-S4-40mm-4th)</SectionTitle>
            ...
            <div className="relative flex justify-between items-start px-4 text-[9px] font-sans">
                <div className="space-y-1 w-2/3">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <input className="border-b border-black w-24 outline-none text-center" {...register("p81_dhf_offset")} />
                    </div>
                    <p>Disch 3-Page8-[KM4 SV OFST] =</p>
                </div>

                <div className='absolute top-[-18%] right-[-1%] flex flex-col items-end gap-1'>
                    <FinalEDWwireCheck prefix="p81_" />
            ...
            <div className="px-4 mb-4">
                ...
                <div className="flex items-center gap-4 text-[10px] mt-1">
                    <div className="flex items-center gap-2 ml-auto">
                        ...
                        <FormItemCheck checkboxSize="w-4 h-4" name="p81_wb_upper" label="Upper Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p81_wb_lower" label="Lower Guide" showCheckbox />
                        <FormItemCheck checkboxSize="w-4 h-4" name="p81_wb_work" label="Work Piece" showCheckbox />
                    </div>
                    ...
                    <div className="text-[9px] font-bold">
                        <div className="flex justify-between">
                            <div className="flex items-center gap-1">
                                ...
                                <input className="border-b border-black w-24 text-center outline-none" {...register("p81_max_no")} />
                            </div>
                            <div className="flex items-center gap-1">
                                <span>Minimum No.</span>
                                <input className="border-b border-black w-24 text-center outline-none" {...register("p81_min_no")} />
                            </div>
                        </div>

                        <div className="flex items-center gap-1">
                            <span>Culculate Range error fallowing formula --&gt; [ Max ] - [ Min ] = </span>
                            <input className="border-b border-black w-20 text-center outline-none" {...register("p81_range_error")} />
                        </div>

                        <div className="flex items-center gap-1">
                            <span>Culculate Size error fallowing formula --&gt; [ (a-e) Mid ] - [ (c-g) Mid ] = </span>
                            <input className="border-b border-black w-20 text-center outline-none" {...register("p81_size_error")} />
                        </div>
                    </div>
                </div>
