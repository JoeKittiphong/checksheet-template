...
// Images
import image18_1 from "@/assets/FAMB0008_V1/FAMB0008-14-1.PNG"; // Fallback from image-11
import image18_2 from "@/assets/FAMB0008_V1/FAMB0008-14-2.PNG"; // Fallback from image-11
                ...
                <div>
                    ...
                    <div className="flex justify-center">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="flex">
                                <img src={image18_1} alt="page8-1" className="w-10" />
                                <FormInputCheckSTD
                                    name="page8.spacer18_1"
                                    label="SPACER = "
                                    unit="mm"
                                    minStd={0}
                                    maxStd={3}
                            ...
                            <img src={image18_2} alt="page8-2" className="w-60" />
                            <FormCheckedBox name="page8.checkedInfo18" />
                        </div>
                    </div>
                </div>
            </div>
