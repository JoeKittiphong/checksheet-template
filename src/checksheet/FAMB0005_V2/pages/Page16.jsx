...
// Images
import image27 from "@/assets/FAMB0005_V2/image-22-1.PNG";
...
function Page16() {
    ...
    const defaultBodyRows = [
        ...
        },
        {
            ...
            partName: "LM-GUIDE Y",
            points: [
                { check: "CS 6X25", qty: 24, torque: 150 },
                { check: "H.S.CTSK[M6X18(SCM)]", qty: 24, torque: 50 }
            ],
            actionBy: '', actionDate: '', doubleBy: '', doubleDate: ''
        },
        {
        ...
        },
        {
            ...
            points: [{ check: "CS 6X30", qty: 16, torque: 150 }],
            actionBy: '', actionDate: '', doubleBy: '', doubleDate: ''
        },
        {
            no: 6,
