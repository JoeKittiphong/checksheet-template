 ...
 * ตารางแสดงข้อมูล Pitching แบบแนวนอน
 * - แถว: Header (1,2,3...), STD, Pitching (input)
 * - ลูกศรซ้าย/ขวา (← →) สำหรับ X axis
 * 
 * @param {Object} props
 ...
 * @param {string} props.label - label สำหรับ row input (default: 'Pitching')
 */
function EDMTablePitchingX({
    data = [],
    onChange = () => { },
    standards = [],
    cols = 5,
    ...
    // แปลงค่าที่แสดงเป็นลูกศร (ซ้าย/ขวา สำหรับ Pitching X)
