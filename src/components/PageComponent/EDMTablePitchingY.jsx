 ...
 * ตารางแสดงข้อมูล Pitching แบบแนวตั้ง (สำหรับ Y axis)
 * - คอลัมน์: No., STD, PITCHING
 * - ลูกศรขึ้น/ลง (↑ ↓)
...
function EDMTablePitchingY({
    ...
    // แปลงค่าที่แสดงเป็นลูกศร (ขึ้น/ลง สำหรับ Y axis)
        ...
        <table className="border-collapse border border-black text-sm">
            <thead>
                <tr>
                    ...
                    <th className="border border-black py-0.5 px-1 w-14">PITCHING</th>
                </tr>
            </thead>
            <tbody>
                {renderRows()}
